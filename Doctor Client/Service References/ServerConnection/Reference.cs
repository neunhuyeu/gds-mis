...
namespace Doctor_Client.ServerConnection {
    ...
    public interface IDoctor {
        ...
        Doctor_Client.ServerConnection.Patient[] search(string firstName, string lastName, string dateOfBirth, int insuranceNumber);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctor/search", ReplyAction="http://tempuri.org/IDoctor/searchResponse")]
        System.Threading.Tasks.Task<Doctor_Client.ServerConnection.Patient[]> searchAsync(string firstName, string lastName, string dateOfBirth, int insuranceNumber);
    ...
    public partial class DoctorClient : System.ServiceModel.ClientBase<Doctor_Client.ServerConnection.IDoctor>, Doctor_Client.ServerConnection.IDoctor {
        ...
        public Doctor_Client.ServerConnection.Patient[] search(string firstName, string lastName, string dateOfBirth, int insuranceNumber) {
            return base.Channel.search(firstName, lastName, dateOfBirth, insuranceNumber);
        }
        
        public System.Threading.Tasks.Task<Doctor_Client.ServerConnection.Patient[]> searchAsync(string firstName, string lastName, string dateOfBirth, int insuranceNumber) {
            return base.Channel.searchAsync(firstName, lastName, dateOfBirth, insuranceNumber);
        }
