...
namespace Doctor_Client.ServerConnection {
    ...
    public interface IDoctor {
        ...
        Doctor_Client.ServerConnection.Patient[] search(string first, string last, string dateOfBirth, int insurance);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctor/search", ReplyAction="http://tempuri.org/IDoctor/searchResponse")]
        System.Threading.Tasks.Task<Doctor_Client.ServerConnection.Patient[]> searchAsync(string first, string last, string dateOfBirth, int insurance);
    ...
    public partial class DoctorClient : System.ServiceModel.ClientBase<Doctor_Client.ServerConnection.IDoctor>, Doctor_Client.ServerConnection.IDoctor {
        ...
        public Doctor_Client.ServerConnection.Patient[] search(string first, string last, string dateOfBirth, int insurance) {
            return base.Channel.search(first, last, dateOfBirth, insurance);
        }
        
        public System.Threading.Tasks.Task<Doctor_Client.ServerConnection.Patient[]> searchAsync(string first, string last, string dateOfBirth, int insurance) {
            return base.Channel.searchAsync(first, last, dateOfBirth, insurance);
        }
